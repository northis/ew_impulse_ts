...
4. **Wave 4** length drawn from `[wave1–wave3 gap × 1.05, wave3Len − rest]`.
   ...
   - Wave 4 reaches at least the **23.6%** level of Wave 2, measured with 0 at the
     end of Wave 1 and 1 at the end of Wave 2 (hard rule; `MIN_WAVE4_W2_LEVEL`,
     DIAGONAL.md §4 D-W4-24).
