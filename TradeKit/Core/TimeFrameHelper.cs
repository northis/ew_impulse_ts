    ...
    internal static class TimeFrameHelper
    {
        static TimeFrameHelper()
        {
            var timeFramesList = new List<TimeFrameInfo>
            {
                ...
                new(TimeFrame.Minute5, TimeSpan.FromMinutes(5), TimeFrame.Minute, TimeFrame.Minute20),
                ...
                new(TimeFrame.Hour, TimeSpan.FromHours(1), TimeFrame.Minute30, TimeFrame.Hour4),
