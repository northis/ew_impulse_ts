    ...
    public static class TimeFrameHelper
    {
        static TimeFrameHelper()
        {
            var timeFramesList = new List<TimeFrameInfo>
            {
                ...
                new(TimeFrame.Minute30, TimeSpan.FromMinutes(30), TimeFrame.Minute, TimeFrame.Minute45),
                new(TimeFrame.Minute45, TimeSpan.FromMinutes(45), TimeFrame.Minute, TimeFrame.Hour),
                new(TimeFrame.Hour, TimeSpan.FromHours(1), TimeFrame.Minute, TimeFrame.Hour2),
